  ...
  return (
    <div className="mt-5 d-flex flex-wrap">
      ...
      <div style={{ margin: ' 10 20px' }}>
        <h3 style={{ color: '#a06881' }}>The Piece: {pieceDetails.piece_type}</h3>
        <h4 style={{ color: '#565264' }}>Where to found this piece: {pieceDetails.source}</h4>
        <h4 style={{ color: '#565264' }}>I am getting this piece: {pieceDetails.condition}</h4>
      </div>
    </div>
  );
}
